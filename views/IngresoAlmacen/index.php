        ...
        <form class="col-12 border p-2 mt-2 bg-light" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center p-2" id="divTabla">
                <div class="col-lg-10 p-2">
                    <table id="IngresoAlmacenTabla" class="table table-bordered  table-responsive table-hover">
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>LOTE</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive" id="divTabla1">
                        <table class="table table-hover table-condensed table-bordered w-100" id="IngresoAlmacenTabla1">
    ...
    <div class="modal-dialog modal-xl">
        <form id="formSalida1" class="col-12 border p-2 mt-2 bg-light">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive" id="divTabla1">
                        <table class="table table-hover table-condensed table-bordered w-100 text-center" id="SalidaFab1">
                            <thead class="table-dark text-center">
                                <tr>
                                    <th>NO</th>
                                    <th>LOTE</th>
...
<div class="modal fade" id="Rechazofab" name="modalPersonal" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form id="formRechazo1" class="col-12 border p-2 mt-2 bg-light">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="table-responsive" id="divTabla1">
                        <table class="table table-hover table-condensed table-bordered w-100 text-center" id="RechazoAlmacen">
                            <thead class="table-dark text-center">
                                <tr>
                                    <th>NO</th>
                                    <th>LOTE</th>
