                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/almacenComando"><i
                                        class="ms-lg-0 ms-2 bi bi-person-check me-2"></i>Almacen Comando</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/Batallon"><i
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/Situaciones"><i
                                        class="ms-lg-0 ms-2 bi bi bi-card-list me-2"></i>Reporte</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/inspectoriaG"><i
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            ...
                            <!-- <h6 class="dropdown-header">Información</h6> -->
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/IngresoFab"><i
                                        class="ms-lg-0 ms-2 bi bi-house me-2"></i>Ingresos Fabrica Municion</a>
                            </li>
                            <h6 class="dropdown-header">Almacen General S.M.G.</h6>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/IngresoAlmacen"><i
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/Lote"><i
                                        class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Lote</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/ejemplo/Calibre"><i
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/ejemplo/busqueda">Busqueda  <i
