<div class="row text-center">
    <div class="col">
        <h1>Formulario Ingreso de Munición Fabrica</h1>
    </div>
</div>
<div class="row justify-content-center">
    <form id="formIngresoFab" class="col-lg-8 border rounded bg-light p-3">
                    ...
                    <form class="badge-light p-1 was-validated" id="formDatosTablaFabrica">
                        ...
                        <div class="row mb-3">
                            <div class='col-lg-6'>
                                ...
                                <input type="hidden" id="idmotivo1" name="idmotivo1" class="form-control" required
                                    readonly>
                        ...
                        <div class="row mb-3">
                            <div class='col-lg-4'>
                                ...
                                <input type="number" id="cantidadnew1" name="cantidadnew1" class="form-control"
                                    required>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <textarea type="tex" name="observaciones1" id="observaciones1" class="form-control"
                                    rows="3"
