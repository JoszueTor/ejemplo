...
<div class="row justify-content-center">
    <form id="formhelado" class="col-lg-4 border rounded bg-light p-3">
        <input type="hidden" name="id" id="id">
        <div class="row mb-3">
            <div class="col-lg-12">
                <label for="descripcion">Descripcion del helado</label>
...
<div class="row justify-content-center" id="divTabla">
    <div class="col-lg-10">
        <table id="heladoTabla" class="table table-bordered table-hover w-100">
            <thead>
                <tr>
                    <th>NO.</th>
                    <th>NOMBRE</th>
...
<script src="build/js/helado/index.js"></script>